...
//        Write _brudnopis.a.a method named hasSameLastDigit with three parameters of type int.
...
public class Ex21_hasSameLastDigit {
    ...
    public static boolean hasSameLastDigit(int a, int b, int c) {
        ...
        if (range.contains(a) && range.contains(b) && range.contains(c)) {
            while (x == z || y == z) {
                return true;
            }
        }
