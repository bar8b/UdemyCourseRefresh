...
public class Ex10_playingCatInSummer {
...
//    Write _brudnopis.a.a method isCatPlaying that has 2 parameters. Method needs to return true if the cat is playing, otherwise return false
...
//            * Do not add the main method to the solution code.
    ...
    public static boolean isCatPlaying(boolean summer, int temp) {
        boolean play = false;
        if (summer == true) {
            play = (temp <= 45 && temp >= 25) ? true : false;
        } else {
            play = (temp <= 35 && temp >= 25) ? true : false;
        }
        return play;
    }
