...
//        Write _brudnopis.a.a method called inputThenPrintSumAndAverage that does not have any parameters.
//        The method should not return anything(void)and it needs to keep reading int numbers from the keyboard.
//        When the user enters something that is not an int then it needs to print _brudnopis.a.a message in the format"SUM = XX AVG = YY".
//        XX represents the sum of all entered numbers of type int.
//        YY represents the calculated average of all numbers of type long.
//        EXAMPLES OF INPUT/OUTPUT:
//        EXAMPLE 1:
//        INPUT:
//        1, 2, 3, 4, 5, _brudnopis.a.a
//        OUTPUT
//        SUM=15AVG=3
//
//        EXAMPLE 2:
...
//        TIP:Use casting when calling the round method since it needs double as _brudnopis.a.a parameter.
