...
public class Ex2_mbAndKb {

    //Write _brudnopis.a.a method called printMegaBytesAndKiloBytes that has 1 parameter of type int with the name kiloBytes.
    //The method should not return anything (void) and it needs to calculate the megabytes
    // and remaining kilobytes from the kilobytes parameter.Then it needs to print _brudnopis.a.a message
